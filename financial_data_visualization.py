...
file_path = 'all_NASDAQ_stocks.txt'
...
class FinancialDataVisualizer:
    ...
    def plot_volume(self):
        ...
        plt.bar(self.data.index, self.data['Volume'], color='blue', width=45)
        plt.xlabel('Year')
        plt.xticks(rotation=35)
    ...
    def plot_correlation_heatmap(self):
        ...
        plt.imshow(corr, cmap='red', interpolation='nearest')
        plt.colorbar()
...
game_button = tk.Button(root, text="Just play a game instead", command=play_game, bg="green",
